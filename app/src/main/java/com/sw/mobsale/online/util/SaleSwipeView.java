...
public class SaleSwipeView extends LinearLayout {

    private static final String TAG = "SaleSwipeView";
    ...
    public SaleSwipeView(Context context) {
        super(context);
        initView();
    }

    public SaleSwipeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }
    ...
    private void initView() {
        ...
        View.inflate(mContext, R.layout.layout_swipe_sale, this);

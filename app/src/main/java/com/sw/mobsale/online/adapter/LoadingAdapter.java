...
public class LoadingAdapter extends BaseAdapter {
    ...
    //构造方法
    public LoadingAdapter(Context context, List<Map<String, Object>> dataLists) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.item_loading_lv, parent, false);
            viewHolder.ivIcon = (ImageView) convertView.findViewById(R.id.fg_loading_item_iv);
            viewHolder.tvName = (TextView) convertView.findViewById(R.id.fg_loading_item_tvname);
            viewHolder.tvInfo = (TextView) convertView.findViewById(R.id.fg_loading_item_tvinfo);
            viewHolder.tvNumber = (TextView) convertView.findViewById(R.id.fg_loading_item_tv_number);
            viewHolder.tvPrice = (TextView) convertView.findViewById(R.id.fg_loading_item_tv_price);
            viewHolder.tvUnitName = (TextView) convertView.findViewById(R.id.fg_loading_item_tv_unitName);
